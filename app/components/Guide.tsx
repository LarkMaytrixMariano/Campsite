  ...
  return (
   <section className='flexCenter flex-col'>
    ...
    <div className='flexCenter max-container relative w-full'>
      ...
      />
      <div className='absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border show-md md:left-[5%] lg:top-20'>
        <Image 
          src="/meter.svg"
          alt="meter"
          width={16}
        ...
        <div className='flexBetween flex-col'>
          ...
          <div className='flex w-full flex-col'>
            ...
            <h4 className='bold-20 mt-2 whitespace-nowrap'>Wano Arc Pasuruan</h4>
          </div>
        </div>
      </div>
    </div>
